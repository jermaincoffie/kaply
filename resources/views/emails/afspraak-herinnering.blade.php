...
<table width="520" cellpadding="0" cellspacing="0" border="0" style="max-width:520px; width:100%; background:#fff; border-radius:12px; overflow:hidden; box-shadow:0 1px 4px rgba(0,0,0,.08);">
    ...
    {{-- Header --}}
    <tr>
        <td bgcolor="#f59e0b" style="padding:32px 32px 24px; text-align:center;">
            <p style="margin:0; color:#fff; font-size:22px; font-weight:700;">Herinnering: over {{ $timing }}</p>
            <p style="margin:6px 0 0; color:rgba(255,255,255,.85); font-size:14px;">{{ $afspraak->kapper->salon_naam }}</p>
        </td>
    </tr>
    ...
    <tr>
        <td style="padding:24px 32px 0; text-align:center;">
            <span style="display:inline-block; background:#fffbeb; color:#d97706; font-size:13px; font-weight:600; padding:4px 12px; border-radius:999px;">⏰ Herinnering</span>
        </td>
    </tr>
    ...
    <tr>
        <td style="padding:20px 32px 28px;">
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    <td style="padding:10px 0; font-size:14px; color:#6b7280;">Adres</td>
                    <td style="padding:10px 0; font-size:14px; font-weight:600; color:#111827; text-align:right;">{{ implode(', ', array_filter([$afspraak->kapper->adres, $afspraak->kapper->stad])) }}</td>
                </tr>
                @endif
