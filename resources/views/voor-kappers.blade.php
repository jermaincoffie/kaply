...
<section class="relative overflow-hidden bg-white dark:bg-neutral-900">
    ...
    <div class="relative max-w-5xl mx-auto px-4 sm:px-6 py-20 sm:py-32 text-center">
        <div class="inline-flex items-center gap-2 bg-blue-50 dark:bg-blue-900/30 border border-blue-100 dark:border-blue-800 text-blue-600 dark:text-blue-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-6">
            <span class="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse"></span>
            14 dagen gratis · geen creditcard nodig
        </div>

        <h1 class="text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight text-gray-900 dark:text-white mb-6 leading-tight">
            Meer boekingen.<br>
            <span class="text-blue-600 dark:text-blue-400">Minder gedoe.</span>
        </h1>

        <p class="text-lg sm:text-xl text-gray-500 dark:text-neutral-400 max-w-2xl mx-auto mb-10 leading-relaxed">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <a href="{{ route('kapper.profiel', 'demo-salon') }}" target="_blank"
               class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl bg-gray-100 dark:bg-neutral-800 text-gray-700 dark:text-neutral-300 text-base font-medium hover:bg-gray-200 dark:hover:bg-neutral-700 transition-all">
                Bekijk voorbeeldprofiel
            </a>
        </div>

        <p class="text-gray-400 dark:text-neutral-500 text-xs mt-4">14 dagen gratis · daarna €25/maand excl. BTW · elke maand opzegbaar</p>
    </div>
</section>

{{-- STATISTIEKEN / TRUST BAR --}}
<section class="bg-gray-50 dark:bg-neutral-800 border-y border-gray-100 dark:border-neutral-700 py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6">
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
            ...
            <div>
                <p class="text-2xl sm:text-3xl font-extrabold text-gray-900 dark:text-white">{{ $getal }}</p>
                <p class="text-xs text-gray-500 dark:text-neutral-400 mt-1">{{ $label }}</p>
            </div>
            @endforeach
        </div>
    </div>
...
{{-- HOE HET WERKT --}}
<section id="hoe-werkt-het" class="py-20 px-4 sm:px-6 dark:bg-neutral-900">
    <div class="max-w-5xl mx-auto">
        <div class="text-center mb-14">
            <p class="text-xs font-semibold text-blue-600 dark:text-blue-400 tracking-widest uppercase mb-2">Zo simpel</p>
            <h2 class="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-white">In 3 stappen online</h2>
        </div>
        <div class="grid sm:grid-cols-3 gap-8">
            @foreach([
                ...
                ['2', 'Stel je profiel in', 'Voeg een profielfoto, beschrijving en fotos van je werk toe. Klanten zien direct wie jij bent.', 'M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0118.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z M15 13a3 3 0 11-6 0 3 3 0 016 0z'],
            ...
            <div class="relative text-center">
                ...
                <h3 class="text-base font-bold text-gray-900 dark:text-neutral-100 mb-2">{{ $titel }}</h3>
                <p class="text-sm text-gray-500 dark:text-neutral-400 leading-relaxed">{{ $tekst }}</p>
            </div>
            @endforeach
        </div>
    </div>
...
{{-- FEATURES --}}
<section class="py-20 px-4 sm:px-6 bg-gray-50 dark:bg-neutral-800">
    <div class="max-w-5xl mx-auto">
        <div class="text-center mb-14">
            <p class="text-xs font-semibold text-blue-600 dark:text-blue-400 tracking-widest uppercase mb-2">Alles inbegrepen</p>
            <h2 class="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-white">Alles wat je nodig hebt</h2>
            <p class="text-gray-500 dark:text-neutral-400 mt-3 max-w-lg mx-auto">Geen losse apps meer. Kaply bundelt boekingen, agenda, klanten en marketing in één dashboard.</p>
        </div>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="bg-white dark:bg-neutral-900 border border-gray-100 dark:border-neutral-700 rounded-xl p-5 hover:border-blue-100 dark:hover:border-blue-800 hover:shadow-sm transition-all">
                ...
                <h3 class="text-sm font-semibold text-gray-900 dark:text-neutral-100 mb-1">{{ $titel }}</h3>
                <p class="text-xs text-gray-500 dark:text-neutral-400 leading-relaxed">{{ $tekst }}</p>
            </div>
            @endforeach
        </div>
    </div>
...
{{-- PRICING --}}
<section class="relative overflow-hidden bg-white dark:bg-neutral-900 py-20 px-4 sm:px-6">
    <div class="absolute inset-0 pointer-events-none overflow-hidden">
        <div class="absolute inset-0"
             style="background: radial-gradient(ellipse 120% 80% at 10% 40%, #bfdbfe 0%, transparent 60%), radial-gradient(ellipse 90% 70% at 85% 20%, #c4b5fd 0%, transparent 55%), radial-gradient(ellipse 100% 90% at 50% 80%, #93c5fd 0%, transparent 65%); opacity: 0.38;"></div>
    </div>
    <div class="absolute inset-0 pointer-events-none bg-gradient-to-b from-transparent from-[20%] to-white dark:to-neutral-900"></div>
    <div class="max-w-lg mx-auto relative">
        <div class="text-center mb-10">
            <p class="text-xs font-semibold text-blue-600 dark:text-blue-400 tracking-widest uppercase mb-2">Prijzen</p>
            <h2 class="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-white">Eén eenvoudig tarief</h2>
            <p class="text-gray-500 dark:text-neutral-400 mt-3">Geen verborgen kosten, geen commissie per boeking.</p>
        </div>
...
{{-- FAQ --}}
<section class="py-20 px-4 sm:px-6 bg-gray-50 dark:bg-neutral-800" x-data="{ open: null }">
    <div class="max-w-2xl mx-auto">
        <div class="text-center mb-12">
            <p class="text-xs font-semibold text-blue-600 dark:text-blue-400 tracking-widest uppercase mb-2">Veelgestelde vragen</p>
            <h2 class="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-white">Vragen?</h2>
        </div>
        ...
        <div class="space-y-2">
            ...
            <div class="bg-white dark:bg-neutral-900 border border-gray-100 dark:border-neutral-700 rounded-xl overflow-hidden">
                <button @click="open = open === {{ $i }} ? null : {{ $i }}"
                        class="w-full flex items-center justify-between px-5 py-4 text-left text-sm font-semibold text-gray-900 dark:text-neutral-100 hover:bg-gray-50 dark:hover:bg-neutral-800 transition-colors">
                    {{ $vraag }}
                    <svg class="w-4 h-4 text-gray-400 dark:text-neutral-500 transition-transform flex-shrink-0 ml-4"
                ...
                <div x-show="open === {{ $i }}"
                     ...
                     x-cloak>
                    <p class="px-5 pb-4 text-sm text-gray-500 dark:text-neutral-400 leading-relaxed border-t border-gray-100 dark:border-neutral-700 pt-3">{{ $antwoord }}</p>
                </div>
            </div>
            @endforeach
        </div>
