<div x-data="pwaBanner()" x-show="tonen" x-cloak
    ...
    <div class="bg-neutral-900 border border-neutral-700 rounded-2xl shadow-2xl p-4 flex items-center gap-3">
        ...
        <div class="flex-1 min-w-0">
            ...
            <p x-show="isIos" class="text-xs text-neutral-400 mt-0.5">
                Tik <svg class="inline w-3.5 h-3.5 mb-0.5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2v13M7 7l5-5 5 5M3 18h18v3H3z"/></svg> en kies <strong class="text-neutral-300">"Zet op beginscherm"</strong>
            </p>
            <p x-show="!isIos" class="text-xs text-neutral-400 mt-0.5">Installeer de app voor snelle toegang</p>
        </div>
