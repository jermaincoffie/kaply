...
<div class="max-w-md mx-auto px-4 py-16 text-center">
    ...
    <h1 class="text-xl font-bold text-gray-900 dark:text-neutral-100 mb-2">Afspraak geannuleerd</h1>
    <p class="text-sm text-gray-500 dark:text-neutral-400 mb-8">De annuleringskosten zijn verwerkt en je afspraak is geannuleerd.</p>
    ...
    <div class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-2xl p-6 text-left space-y-3 mb-8">
        ...
        <div class="flex justify-between text-sm border-t border-gray-100 dark:border-neutral-700 pt-3 mt-3">
            <span class="text-gray-500 dark:text-neutral-400">Annuleringskosten</span>
            <span class="font-semibold text-amber-600 dark:text-amber-400">€ {{ number_format($afspraak->kapper->annulering_kosten / 100, 2, ',', '') }}</span>
        </div>
    </div>
