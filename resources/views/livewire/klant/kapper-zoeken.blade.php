<div x-data="{ sticky: false }" @scroll.window="sticky = window.scrollY > 220" class="relative bg-white dark:bg-neutral-900">
    ...
    <div class="absolute pointer-events-none overflow-hidden" style="top:0;left:0;right:0;height:700px;">
        <div class="absolute inset-0"
             style="background: radial-gradient(ellipse 120% 60% at 5% 0%, #bfdbfe 0%, transparent 60%), radial-gradient(ellipse 90% 60% at 90% 0%, #c4b5fd 0%, transparent 55%), radial-gradient(ellipse 100% 90% at 50% 80%, #93c5fd 0%, transparent 65%); opacity: 0.45;"></div>
    </div>
    {{-- Fade overlay --}}
