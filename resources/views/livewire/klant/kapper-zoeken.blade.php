<div x-data="{ sticky: false }" @scroll.window="sticky = window.scrollY > 220" class="relative bg-white dark:bg-neutral-900">
    ...
    {{-- Hero --}}
    <div class="relative overflow-hidden z-10 py-6 sm:py-20 px-4">
    ...
    <div class="relative z-10 max-w-5xl mx-auto px-4 pb-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <a href="{{ route('kapper.profiel', $kapper->slug) }}"
               class="group flex flex-col bg-gradient-to-b from-[#eff8ff] to-white dark:from-neutral-700 dark:to-neutral-800 border border-[#dbeafe] dark:border-neutral-700 rounded-xl overflow-hidden hover:shadow-md hover:border-blue-200 dark:hover:border-neutral-500 transition-all duration-150">
