    ...
    <div class="space-y-5">
        ...
        <div class="bg-white dark:bg-neutral-800 border border-red-200 dark:border-red-900/50 rounded-xl p-6">
            ...
            <p class="text-xs text-gray-500 dark:text-neutral-400 mb-4">
                Je account en alle bijbehorende gegevens worden permanent verwijderd. Dit kan niet ongedaan worden gemaakt.
            </p>
            <button wire:click="verwijderAccount"
                    wire:confirm="Weet je zeker dat je je account wilt verwijderen? Al je gegevens worden permanent gewist en dit kan niet ongedaan worden gemaakt."
