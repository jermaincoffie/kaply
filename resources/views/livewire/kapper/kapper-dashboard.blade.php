<div>
    ...
    <div class="grid grid-cols-2 gap-3">
        ...
        {{-- Afspraken --}}
        <a href="{{ route('kapper.agenda') }}" class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-2xl p-4 block hover:border-blue-300 dark:hover:border-blue-700 hover:shadow-sm transition-all">
        ...
        {{-- Klanten --}}
        <a href="{{ route('kapper.klanten') }}" class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-2xl p-4 block hover:border-blue-300 dark:hover:border-blue-700 hover:shadow-sm transition-all">
            <div class="flex items-center gap-1.5 mb-2">
                <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {{-- Omzet --}}
        <a href="{{ route('kapper.statistieken') }}" class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-2xl p-4 block hover:border-blue-300 dark:hover:border-blue-700 hover:shadow-sm transition-all">
            <div class="flex items-center gap-1.5 mb-2">
                <svg class="w-4 h-4 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
