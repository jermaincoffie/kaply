<div>
    ...
    <div class="flex flex-wrap gap-3 mb-4">
        ...
        <select wire:model.live="filterStatus"
                class="py-1.5 pl-3 pr-8 text-sm rounded-lg border border-gray-200 dark:border-neutral-700 bg-white dark:bg-neutral-800 text-gray-700 dark:text-neutral-300 focus:outline-none focus:ring-2 focus:ring-blue-500">
