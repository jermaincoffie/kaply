...
<aside id="sidebar"
    ...
    <div class="px-3 pb-4 pt-2 border-t border-gray-100 dark:border-neutral-700 flex-shrink-0 space-y-0.5">
        ...
        {{-- Support --}}
        <div class="pt-2 mt-2 border-t border-gray-100 dark:border-neutral-700 space-y-0.5">
            <a href="mailto:info@kaply.nl"
               class="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-500 dark:text-neutral-500 hover:bg-gray-100 dark:hover:bg-neutral-700 hover:text-gray-700 dark:hover:text-neutral-300 transition-colors">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
